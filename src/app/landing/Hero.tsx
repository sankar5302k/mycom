...
function Hero() {
  return (
    ...
    />
    </div> <p className="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
                Welcome to <span className="border-b border-dotted border-slate-300">MyCommunity</span>
            </p>

            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                <span className="inline-block">Revolutionizing
                    <span className="relative whitespace-nowrap text-green-600">
                        ...
                        <span className="relative"> Dialogues</span>
                    </span>
                </span>
                <span className="inline-block">&nbsp;Across boundaries</span>
            </h1>
