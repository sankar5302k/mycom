...
function Ad() {
  ...
  <p className="text-center mt-6 text-lg font-light text-gray-500">
    We are providing anonymous , public works and general discussion forums 
  </p>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-3">
  <div className="p-8">
    ...
    <h2 className="uppercase mt-6 text-indigo-500 font-medium mb-3">
      Public work discussions
    </h2>
    <p className="font-light text-sm text-gray-500 mb-3">
      In this discussion forums a moderator from a area can actually <Highlight>hire a persons for the public work with wage</Highlight> 
    </p>
